...
outputName = "autoencoder_" + sampleType[0] + scoreType[indexScore] + groupName[indexGroup] + "_" + str(num_feature) + "_" + str(learning_rate) + ".pth"
...
np.savetxt(featureName, featureList, delimiter='\t')